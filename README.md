...
environment variables (see below) and run with `python3 -m tgbotfilestream`.
...
* `TG_SESSION_NAME` (defaults to `tgbotfilestream`) - The name of the Telethon session file to use.
